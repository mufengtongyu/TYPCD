...
class AdditiveAttention(nn.Module):
    ...
    def forward(self, encoder_states, decoder_state): # encoded_edges：torch.Size([256, 1, 128]),node_history_encoder：torch.Size([256, 128])
        ...
        # attention_probs is of shape (batch, num_enc_states, 1) #256，1，1  全是1

        final_context_vec = torch.sum(attention_probs * encoder_states, dim=1)
        # final_context_vec is of shape (batch, enc_dim)

        return final_context_vec, attention_probs #只取第一个final_context_vec 基本全0
