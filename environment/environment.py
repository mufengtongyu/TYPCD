...
class Environment(object):
    ...
    # 返回标准化参数。根据给定的状态和节点类型，获取相应的标准化均值和标准差参数
    ...
    # 对数组进行标准化。根据给定的状态、节点类型以及可选的均值和标准差参数，对数组进行标准化处理。
    def standardize(self, array, state, node_type, mean=None, std=None): #array：（8，12）
